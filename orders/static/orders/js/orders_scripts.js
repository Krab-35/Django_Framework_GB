...
//        }
        ...
        $('.order_form').on('click', 'input[type="number"]', function () {
            ...
            orderitem_num = parseInt(target.name.raplace('orderitems-', '').replace('-quantity', ''));
...
//            }
    ...
    $('.order_form select').change(function () {
        ...
        var orderitem_product_pk = target.options[target.selectIndex].value;
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.price) {
                    ...
                    if (isNan(current_tr.find('input[type="number"]').value())) {
